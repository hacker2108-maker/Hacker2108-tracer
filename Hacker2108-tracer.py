...
def banner():
    # Add the Hacker2108 tracer banner here
    print(f"""
{Gr}██╗  ██╗ █████╗  ██████╗██╗  ██╗███████╗██████╗ {Wh}██████╗ {Gr}░░███╗░░ ██████╗  █████╗ 
{Gr}██║  ██║██╔══██╗██╔════╝██║ ██╔╝██╔════╝██╔══██╗{Wh}╚════██╗{Gr}░████║░░██╔═████╗██╔══██╗
{Gr}███████║███████║██║     █████╔╝ █████╗  ██████╔╝{Wh} █████╔╝{Gr}██╔██║░░██║██╔██║╚█████╔╝
...
{Wh}╔══════════════════════════════════════════════════════════════════════╗
{Wh}║ {Gr}[+] {Blu}Author  : {Cy}hacker2108-maker                                              {Wh}║
{Wh}║ {Gr}[+] {Blu}GitHub  : {Cy} https://github.com/hacker2108-maker/Tool-installer.git                           {Wh}║
{Wh}║ {Gr}[+] {Blu}Tool    : {Cy}Hacker2108 Tracer                                    {Wh}║
{Wh}║ {Gr}[+] {Blu}Version : {Cy}1.0                                                  {Wh}║
{Wh}╚══════════════════════════════════════════════════════════════════════╝
    """)
